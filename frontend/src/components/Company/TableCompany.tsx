...
import { fetch, deleteItem } from '../../stores/company/companySlice';
...
const TableSampleCompany = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { company, loading, count } = useAppSelector((state) => state.company);
  ...
  const companyPaginated = Array.from(

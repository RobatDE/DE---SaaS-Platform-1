...
import { fetch, deleteItem } from '../../stores/campaigns/campaignsSlice';
...
const TableSampleCampaigns = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { campaigns, loading, count } = useAppSelector(
  ...
  const campaignsPaginated = Array.from(
  ...
  const handleDeleteAction = async () => {
    if (id) {
      ...
      setIsModalTrashActive(false);
      notify('success', 'Campaigns was deleted!');
    }
  };

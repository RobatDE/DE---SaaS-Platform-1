...
import { fetch, deleteItem } from '../../stores/history/historySlice';
...
const TableSampleHistory = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { history, loading, count } = useAppSelector((state) => state.history);
  ...
  const historyPaginated = Array.from(
  ...
  const handleDeleteAction = async () => {
    if (id) {
      ...
      setIsModalTrashActive(false);
      notify('success', 'History was deleted!');
    }
  };
...
export default TableSampleHistory;

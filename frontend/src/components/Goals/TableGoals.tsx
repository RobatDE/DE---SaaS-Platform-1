...
import { fetch, deleteItem } from '../../stores/goals/goalsSlice';
...
const TableSampleGoals = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { goals, loading, count } = useAppSelector((state) => state.goals);
  ...
  const goalsPaginated = Array.from(
  ...
  const handleDeleteAction = async () => {
    if (id) {
      ...
      setIsModalTrashActive(false);
      notify('success', 'Goals was deleted!');
    }
  };

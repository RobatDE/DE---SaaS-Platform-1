...
import { fetch, deleteItem } from '../../stores/audiences/audiencesSlice';
...
const TableSampleAudiences = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { audiences, loading, count } = useAppSelector(
  ...
  const audiencesPaginated = Array.from(
  ...
  const handleDeleteAction = async () => {
    if (id) {
      ...
      setIsModalTrashActive(false);
      notify('success', 'Audiences was deleted!');
    }
  };
...
export default TableSampleAudiences;
